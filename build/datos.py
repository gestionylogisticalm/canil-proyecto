...
PARTIDAS = [
    {
        ...
        "items": [
            ("A.1", "Levantamiento topográfico y planos del terreno (≈1,1 ha)", 1, "gl", 1500000, 1500000, COMPRA, REFERENCIAL, "Cotizar con topógrafos de la zona"),
            ("A.2", "Diseño de arquitectura y especialidades, incluido cálculo estructural de la torre y paisajismo", 1, "gl", 6000000, 6000000, COMPRA, REFERENCIAL, "Estimación; puede reducirse con profesionales municipales (Secplan y DOM)"),
    ...
    },
    {
        ...
        "items": [
            ...
            ("B.2", "Baño químico para trabajadores", 4, "mes", 120000, 480000, COMPRA, REFERENCIAL, "Arriendo mensual; cotizar"),
    ...
    },
    {
        ...
        "items": [
            ...
            ("F.8", "Cerraduras electromagnéticas exteriores con temporizador y apertura interior libre", 5, "u", 180000, 900000, COMPRA, REFERENCIAL, "Cotizar"),
            ("F.9", "Luminarias LED solares de grado exterior con sensor de movimiento", 30, "u", 65000, 1950000, COMPRA, REFERENCIAL, "Los productos de consumo desde $16.990 (Sodimac.cl) no son aptos para uso público intensivo; cotizar grado público"),
    ...
    },
    {
        ...
        "items": [
            ...
            ("I.6", "Prevencionista de riesgos (media jornada)", 4, "mes", 400000, 1600000, COMPRA, REFERENCIAL, "Cotizar"),
            ("I.7", "Retroexcavadora con operador: fosa, zanjas y apoyo al pozo", 24, "hora", 45000, 1080000, COMPRA, REFERENCIAL, "Cotizar localmente"),
            ("I.8", "Camión con chofer: troncos, grava y materiales", 10, "día", 180000, 1800000, COMPRA, REFERENCIAL, "Cotizar localmente"),
